...
type
  TFfrmPrecoMercadoria = class(TForm)
...
var
  FfrmPrecoMercadoria: TFfrmPrecoMercadoria;
...
procedure TFfrmPrecoMercadoria.sbEditarClick(Sender: TObject);
begin
...
procedure TFfrmPrecoMercadoria.sbImprimirClick(Sender: TObject);
begin
...
procedure TFfrmPrecoMercadoria.sbSalvarClick(Sender: TObject);
begin
...
procedure TFfrmPrecoMercadoria.SpeedButton1Click(Sender: TObject);
begin
  FPQMercaEmbalagem;
  if xpqResul<>'0'then
  begin
...
procedure TFfrmPrecoMercadoria.cdsDadosBeforeInsert(DataSet: TDataSet);
begin
  cdsDados.Cancel;
  Abort;
end;

procedure TFfrmPrecoMercadoria.DBGrid1Enter(Sender: TObject);
begin
  FMenu.ACBrEnterTab1.EnterAsTab := False;
  cdsDados.Edit;
end;

procedure TFfrmPrecoMercadoria.DBGrid1Exit(Sender: TObject);
begin
  FMenu.ACBrEnterTab1.EnterAsTab := True;
end;

procedure TFfrmPrecoMercadoria.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if (key =#13) then
  begin
    cdsDados.Edit;
...
procedure TFfrmPrecoMercadoria.Excluir1Click(Sender: TObject);
begin
  cdsDados.Cancel;
end;

procedure TFfrmPrecoMercadoria.FormActivate(Sender: TObject);
begin
  if not cdsDados.Active then cdsDados.Open;
end;

procedure TFfrmPrecoMercadoria.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FreeAndNil(FfrmPrecoMercadoria);
end;
