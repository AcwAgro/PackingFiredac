...
type
  TqrResumoClasse = class(TQuickRep)
    QRBand1: TQRBand;
...
var
  qrResumoClasse: TqrResumoClasse;
...
procedure TqrResumoClasse.QuickRepPreview(Sender: TObject);
begin
  fPreview(Sender);
end;

procedure TqrResumoClasse.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrVenda.Close;
...
procedure TqrResumoClasse.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TqrResumoClasse.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrResumoClasse.fSomaCat;
begin
  vsoma:=0;
...
procedure TqrResumoClasse.fSomaVar;
begin
  vsoma:=0;
  vxcodig2:=frPree(qrVenda.Fields[0].asInteger,7,'0',0);
  while vsoma=0 do begin
