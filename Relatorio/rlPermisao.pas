...
procedure TqrPermisao.QuickRepPreview(Sender: TObject);
begin
  fPreview(Sender);
end;

procedure TqrPermisao.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
begin
  ...
  fSql(1,1,['Select Titulo,Nome,Crea From CadTecni'],1);
  qrLabel15.Caption:='Responsável Técnio: '+dm.qrSql1.Fields[0].Text+' '+
                     dm.qrSql1.Fields[1].Text+'   Crea nº'+dm.qrSql1.Fields[2].Text;
end;
