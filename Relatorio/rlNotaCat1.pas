...
procedure TqrNotaCat1.QuickRepPreview(Sender: TObject);
begin
  vcc:=0;
  fPreview(Sender);
end;

procedure TqrNotaCat1.QRSubDetail2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vcc:=vcc+1;
  ChildBand1.Height:=0;
...
procedure TqrNotaCat1.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrEstoqCom.First;
  vcc:=0;
...
procedure TqrNotaCat1.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var vbruto:Real;
begin
...
procedure TqrNotaCat1.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var vcod:String;
begin
  qrLabel4.Caption:='';
...
procedure TqrNotaCat1.rbDetailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
