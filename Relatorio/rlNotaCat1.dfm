object qrNotaCat1: TqrNotaCat1
  ...
  object qrEstoqCom: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Mid(Codigo,1,4) as vcod, Unidade as vuni, Sum(Qtde) as vq' +
        'td, Sum(RValor) as vval'
      'FROM NFVENDCO'
      'WHERE LANC=120'
      'Group By Mid(Codigo,1,4), Unidade')
    Left = 80
    Top = 16
  end
end
