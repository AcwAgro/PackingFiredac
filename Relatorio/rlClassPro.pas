...
procedure TqrClassPro.QuickRepPreview(Sender: TObject);
begin
  vqtd1:=0; vqtd2:=0; vqtdt1:=0; vqtdt2:=0;
  fPreview(Sender);
end;

procedure TqrClassPro.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vqtd1:=0; vqtd2:=0; vqtdt1:=0; vqtdt2:=0;
end;

procedure TqrClassPro.PageHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrClassPro.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrClassPro.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  ...
  qrLabel7.Caption:=FloatToStrF(vqtd2,ffNumber,9,3);
  qrLabel9.Caption:=FloatToStrF(vqtdt1,ffNumber,9,0);
  qrLabel10.Caption:=FloatToStrF(vqtdt2,ffNumber,9,3);
  qrDados.Next;
  ChildBand1.Height:=0;
