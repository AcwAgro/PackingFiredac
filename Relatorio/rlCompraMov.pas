...
procedure TqrCompraMov.QuickRepPreview(Sender: TObject);
begin
...
procedure TqrCompraMov.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  Page.Orientation:=poLandscape;
  qrConta.First;
...
procedure TqrCompraMov.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
