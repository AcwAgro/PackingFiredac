object FfrmEstoquePalet: TFfrmEstoquePalet
  Left = 191
  Top = 114
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = ' Estoque Palets'
  ClientHeight = 482
  ClientWidth = 1221
  Color = 14930883
  ...
  object RzPanel1: TRzPanel
    ...
    object PMenu: TPanel
      ...
      object GroupBox1: TGroupBox
        ...
        ParentFont = False
        TabOrder = 0
        object CCB20: TRadioButton
          Left = 9
          Top = 20
          Width = 150
          Height = 17
          Caption = 'Palet em Aberto'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object CCB30: TRadioButton
          Left = 9
          Top = 38
          Width = 150
          Height = 17
          Caption = 'Palet Baixado'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'Verdana'
  ...
  object TEstoque: TFDQuery
    ...
    object TEstoqueQABE: TBCDField
      FieldName = 'QABE'
      Origin = 'QABE'
      Precision = 18
    end
    object TEstoqueQBAI: TBCDField
      FieldName = 'QBAI'
      Origin = 'QBAI'
      Precision = 18
    end
