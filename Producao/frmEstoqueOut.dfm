object FfrmEstoqueOut: TFfrmEstoqueOut
  Left = 191
  Top = 114
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Leitura do Estoque Mercadoria/Insumos.'
  ClientHeight = 589
  ClientWidth = 1267
  Color = 14930883
  ...
  object TEstoque: TFDQuery
    ...
    SQL.Strings = (
      'SELECT * FROM RELMERCA')
    Left = 663
    Top = 192
    object TEstoqueLINHA: TIntegerField
      FieldName = 'LINHA'
      Origin = 'LINHA'
    end
    object TEstoqueDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 50
    end
    object TEstoqueUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Origin = 'UNIDADE'
      Size = 10
    end
    ...
    object TEstoqueCAL1: TBCDField
      FieldName = 'CAL1'
      Origin = 'CAL1'
      Precision = 18
    end
    object TEstoqueCAL2: TBCDField
      FieldName = 'CAL2'
      Origin = 'CAL2'
      Precision = 18
    end
    object TEstoqueCAL3: TBCDField
      FieldName = 'CAL3'
      Origin = 'CAL3'
      Precision = 18
    end
    object TEstoqueCAL4: TBCDField
      FieldName = 'CAL4'
      Origin = 'CAL4'
      Precision = 18
    end
    object TEstoqueCAL5: TBCDField
      FieldName = 'CAL5'
      Origin = 'CAL5'
      Precision = 18
    end
    object TEstoqueCAL6: TBCDField
      FieldName = 'CAL6'
      Origin = 'CAL6'
      Precision = 18
    end
    object TEstoqueCAL7: TBCDField
      FieldName = 'CAL7'
      Origin = 'CAL7'
      Precision = 18
    end
    object TEstoqueCAL8: TBCDField
      FieldName = 'CAL8'
      Origin = 'CAL8'
      DisplayFormat = '#,0.00'
      Precision = 18
    end
    object TEstoqueCAL9: TBCDField
      FieldName = 'CAL9'
      Origin = 'CAL9'
      DisplayFormat = '#,0.00'
      Precision = 18
    end
    object TEstoqueCAL10: TBCDField
      FieldName = 'CAL10'
      Origin = 'CAL10'
      Precision = 18
    end
  ...
  object qrEstoque: TFDQuery
    ...
    SQL.Strings = (
        ...
        'Select VarieCod,VarieDes,CategCod,rr.Codigo,Calibre,CategDes, Su' +
        'm(rr.Qtde)'
      'From RelEstoq rr, CadProdu cc'
      'Where rr.Codigo=cc.Codigo'
      'Group By VarieCod,VarieDes,CategCod,rr.Codigo,Calibre,CategDes'
      'Order By rr.Codigo')
    Left = 535
    Top = 192
  end
