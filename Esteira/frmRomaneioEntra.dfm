inherited FfrmRomaneioEntra: TFfrmRomaneioEntra
  ...
  inherited cdsDados: TFDQuery
    ...
    SQL.Strings = (
      'select * from entre where lanc = -1  order by lanc desc')
    Left = 562
    Top = 166
  ...
  object cdsEtiqBins: TFDQuery
    ...
    object cdsEtiqBinsREGLOG: TStringField
      FieldName = 'REGLOG'
      Origin = 'REGLOG'
      Size = 1000
    end
    object cdsEtiqBinsREG_ID: TIntegerField
      FieldName = 'REG_ID'
      Origin = 'REG_ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsEtiqBinsHORA: TStringField
      FieldName = 'HORA'
      Origin = 'HORA'
      Size = 8
    end
