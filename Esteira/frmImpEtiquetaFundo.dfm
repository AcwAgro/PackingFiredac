object FfrmImpEtiquetaFundo: TFfrmImpEtiquetaFundo
  ...
  object sqlTamanho: TFDQuery
    ...
    UpdateOptions.AutoCommitUpdates = True
    SQL.Strings = (
      'Select calibre, calibredes, count(*) as total'
      '  from cadprodu'
      ' where variecod = 110'
      '   and ativo = '#39'S'#39
    ...
    object sqlTamanhoTOTAL: TIntegerField
  ...
  object sqlCategoria: TFDQuery
    ...
    UpdateOptions.AutoCommitUpdates = True
    SQL.Strings = (
      'Select categcod, categdes, count(*) as total'
      '  from cadprodu'
      ' where variecod = 110'
      '   and ativo = '#39'S'#39
    ...
    object sqlCategoriaTOTAL: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      ProviderFlags = []
