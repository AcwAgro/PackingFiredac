...
type
  TFfrmGerenciadorNFE = class(TForm)
    ...
    sqlDadosNFE_CCEDATA: TSQLTimeStampField;
    ...
    sqlDadosNFE_CCE4: TStringField;
    sqlDadosNFE_CCE5: TStringField;
    sqlDadosNFE_CCE6: TStringField;
    sqlDadosNFE_CCE7: TStringField;
    sqlDadosNFE_CCE8: TStringField;
    ...
    TCadastroCIDADECOD: TIntegerField;
    TCadastroCPF: TStringField;
    TCadastroDOC: TStringField;
    TCadastroFONE: TStringField;
    TCadastroLIMITE: TBCDField;
    TCadastroFINAN: TBCDField;
    TCadastroCADASTRO: TSQLTimeStampField;
    TCadastroMENSAGEM: TStringField;
    TCadastroCTC: TIntegerField;
    TCadastroCTCDES: TStringField;
    TCadastroFORMA: TStringField;
    TCadastroCIDADEDES: TStringField;
    TCadastroCOOPER: TStringField;
    TCadastroCTCCON: TIntegerField;
    TCadastroAREA: TBCDField;
    TCadastroEMPRECOD: TIntegerField;
    TCadastroACESOCOD: TIntegerField;
    TCadastroMARCA: TStringField;
    TCadastroFUNSIM: TStringField;
    TCadastroFUNPER: TBCDField;
    TCadastroEMAIL: TStringField;
    TCadastroSITE: TStringField;
    TCadastroCONTATO: TStringField;
    TCadastroCOMISPER: TBCDField;
    TCadastroADIANTCX: TBCDField;
    TCadastroFG_DESC_PRECO: TStringField;
    TCadastroWEBLOCAL: TStringField;
    TCadastroNFDESCPARC: TStringField;
    TCadastroATIVO: TStringField;
    TCadastroREGLOG: TStringField;
    TCadastroREG_ID: TIntegerField;
    TImportacLANCIT: TIntegerField;
    TImportacLANC: TIntegerField;
    TImportacDI_NR: TStringField;
    TImportacDI_DT: TSQLTimeStampField;
    TImportacLOC_DES: TStringField;
    TImportacLOC_UF: TStringField;
    TImportacLOC_DT: TSQLTimeStampField;
    TImportacTRA_VIA: TStringField;
    TImportacTRA_VLR: TBCDField;
    ...
    TImportacIMP_ICM_VLR: TBCDField;
    TImportacIMP_ICM_PER: TBCDField;
    TImportacIMP_OUT_ADV: TBCDField;
    TImportacIMP_OUT_IOF: TBCDField;
    TImportacIMP_IPI_VLR: TBCDField;
    TImportacIMP_IPI_PER: TBCDField;
    TImportacIMP_IPI_COD: TIntegerField;
    TImportacIMP_II_VLR: TBCDField;
    TImportacIMP_II_PER: TBCDField;
    TImportacIMP_II_COD: TIntegerField;
    TImportacIMP_PIS_VLR: TBCDField;
    TImportacIMP_PIS_PER: TBCDField;
    TImportacIMP_PIS_COD: TIntegerField;
    TImportacIMP_COF_VLR: TBCDField;
    TImportacIMP_COF_PER: TBCDField;
    TImportacIMP_COF_COD: TIntegerField;
    TImportacREGLOG: TStringField;
    TImportacREG_ID: TIntegerField;
    TFinanLANCIT: TIntegerField;
    TFinanLANC: TIntegerField;
    TFinanPARC: TIntegerField;
    TFinanVENCTO: TSQLTimeStampField;
    TFinanVALOR: TBCDField;
    TFinanPERC: TBCDField;
    TFinanVLR: TBCDField;
    ...
    TFinanREGLOG: TStringField;
    TFinanREG_ID: TIntegerField;
    TProdutoLANCIT: TIntegerField;
    TProdutoLANC: TIntegerField;
    TProdutoDATA: TSQLTimeStampField;
    TProdutoCLIENTE: TIntegerField;
    TProdutoCODIGO: TIntegerField;
    TProdutoDESCRICAO: TStringField;
    TProdutoUNIDADE: TStringField;
    TProdutoPESOLIQ: TBCDField;
    TProdutoPESOBRU: TBCDField;
    TProdutoQTDE: TBCDField;
    TProdutoUNIT: TFMTBCDField;
    TProdutoVALOR: TBCDField;
    TProdutoGRUPOCOD: TIntegerField;
    TProdutoPERDESC: TBCDField;
    TProdutoVLRDESC: TBCDField;
    TProdutoVENCTO: TSQLTimeStampField;
    TProdutoRUNIT: TFMTBCDField;
    TProdutoRVALOR: TBCDField;
    TProdutoEMPRECOD: TIntegerField;
    TProdutoACESOCOD: TIntegerField;
    TProdutoESTOQUE: TStringField;
    TProdutoNATURCOD: TBCDField;
    TProdutoICMS_SIT: TStringField;
    TProdutoICMS_PER: TBCDField;
    TProdutoICMS_RED: TBCDField;
    TProdutoICMS_BASE: TBCDField;
    TProdutoICMS_VLR: TBCDField;
    TProdutoIPI_SIT: TStringField;
    TProdutoIPI_PER: TBCDField;
    TProdutoIPI_BASE: TBCDField;
    TProdutoIPI_VLR: TBCDField;
    TProdutoPRUNIT: TFMTBCDField;
    TProdutoPREMB: TBCDField;
    TProdutoCODLOTECLASS: TStringField;
    TProdutoNCM_COD: TStringField;
    TProdutoNCM_PER: TBCDField;
    TProdutoNCM_VLR: TBCDField;
    TProdutoICMS_CREDPER: TBCDField;
    TProdutoICMS_CREDVLR: TBCDField;
    TProdutoEHSERVICO: TStringField;
    TProdutoEHSERVPER: TBCDField;
    TProdutoEHSERVVLR: TBCDField;
    TProdutoRVLRMEDIO: TBCDField;
    TProdutoPIS_SIT: TStringField;
    TProdutoPIS_PER: TBCDField;
    TProdutoPIS_BASE: TBCDField;
    TProdutoPIS_VLR: TBCDField;
    TProdutoCOFINS_SIT: TStringField;
    TProdutoCOFINS_PER: TBCDField;
    TProdutoCOFINS_BASE: TBCDField;
    TProdutoCOFINS_VLR: TBCDField;
    TProdutoIPI_CENQ: TStringField;
    TProdutoPRODUTOCOD: TStringField;
    TProdutoNCM_PERE: TBCDField;
    TProdutoNCM_VLRE: TBCDField;
    TProdutoNCM_PERM: TBCDField;
    TProdutoNCM_VLRM: TBCDField;
    TProdutoUTRIB: TStringField;
    TProdutoQTRIB: TBCDField;
    TProdutoVUNTRIB: TFMTBCDField;
    TProdutoCBENEF: TStringField;
    TProdutoREGLOG: TStringField;
    TProdutoREG_ID: TIntegerField;
    ...
    TNotaDATA: TSQLTimeStampField;
    TNotaENTREGA: TSQLTimeStampField;
    TNotaNATURCOD: TBCDField;
    TNotaDADOSCOD: TIntegerField;
    TNotaTRTIPO: TStringField;
    TNotaTRCOD: TIntegerField;
    TNotaTRDES: TStringField;
    TNotaVLRDESC: TBCDField;
    TNotaVLRBASE: TBCDField;
    TNotaVLRICMS: TBCDField;
    TNotaVLRFRETE: TBCDField;
    TNotaVLRPRODUTO: TBCDField;
    TNotaVLRIPI: TBCDField;
    TNotaVLRNOTA: TBCDField;
    TNotaPESOBRU: TBCDField;
    TNotaPESOLIQ: TBCDField;
    ...
    TNotaVLRSEGURO: TBCDField;
    TNotaVLRICMSFRE: TBCDField;
    ...
    TNotaCODLOTECLASS: TStringField;
    TNotaCLI_FUNPER: TBCDField;
    TNotaCLI_COMISPER: TBCDField;
    TNotaCLI_ADIANTCX: TBCDField;
    TNotaNFE_CCE1: TStringField;
    TNotaNFE_CCE2: TStringField;
    TNotaNFE_CCE3: TStringField;
    TNotaNFE_CCESEQ: TIntegerField;
    TNotaNFE_CCEDATA: TSQLTimeStampField;
    TNotaTRIBNCM_PER: TBCDField;
    TNotaTRIBNCM_VLR: TBCDField;
    TNotaVLRCRED: TBCDField;
    TNotaVLRSERV: TBCDField;
    TNotaPERSERV: TBCDField;
    TNotaPIS_VLR: TBCDField;
    TNotaCOFINS_VLR: TBCDField;
    TNotaEMAILENV: TIntegerField;
    TNotaCOMISSAOCOD: TIntegerField;
    TNotaCOMISSAOVLR: TBCDField;
    TNotaCOMISSAOVALOR: TBCDField;
    ...
    TNotaTRIBNCM_PERE: TBCDField;
    TNotaTRIBNCM_VLRE: TBCDField;
    TNotaPRD_FUNRURAL: TBCDField;
    TNotaXSEL: TStringField;
    TNotaREGLOG: TStringField;
    TNotaREG_ID: TIntegerField;
    ...
    tbConfigCER_VALIDADE: TSQLTimeStampField;
    ...
    tbConfigREGLOG: TStringField;
    tbConfigREG_ID: TIntegerField;
...
begin
  ...
  tbConfig.Post;
  tbConfig.ApplyUpdates(-1);

  Sleep(1500);

  dm.TEmpresa.Edit;
  dm.TEmpresa.Post;
  dm.TEmpresa.ApplyUpdates(-1);
...
var sXML, Chave, idLote, CNPJ, nSeqEvento, Correcao : string;
begin
...
//    ACBrNFe1.Configuracoes.Geral.FormatoAlerta := 'Campo:%DESCRICAO% - %MSG%';
    ...
    if (Length(trim(edtValidade.text)) > 7) then
    begin
      vdias := tbConfigCER_VALIDADE.asDateTime - Date;
      if vdias <= 0 then
        frPerg(PChar('Certificado Dígital Exprirado em '+FormatDateTime('dd/mm/yyyy',tbConfigCER_VALIDADE.asDateTime)),'OK')
      else
        if vdias <= 15 then
          frPerg(PChar('* ATENÇÃO * '#13'Falta '+FloatToStr(vdias)+' dia(s) para expirar o Certificado Dígital !'#13'Data para Expirar : '+FormatDateTime('dd/mm/yyyy',tbConfigCER_VALIDADE.asDateTime)),'OK');
    end;
...
{  TNota.Close;
  ...
  TNota.Close;
  TNota.SQL.Clear;
  TNota.SQL.Add('select * from nfvenda');
  TNota.SQL.Add('where NFE_Modelo = '+QuotedStr('55'));
  TNota.SQL.Add('  and '+frWhereD('Data',dtInicial.Date,dtFinal.Date));
  TNota.SQL.Add('order by lanc desc');
  TNota.Open;
...
begin
 try
   ...
   begin
     ...
     Ide.dEmi      := TNotaData.asDateTime;
     Ide.dSaiEnt   := TNotaEntrega.asDateTime;
     Ide.hSaiEnt   := Now;
...
//***CEST
     ...
     begin
       ...
       Total.ISSQNTot.dCompet := TNotaData.asDateTime;
     end
     else begin
...
{    if TNotaNFE_Status.AsString = 'CA' then
    ...
    //VLOGO := ACBrNFe1.NotasFiscais.Items[0].NomeArq;
    //ACBrNFe1.DANFE.GetNamePath. := frExtrairArquivoNome(sxml);
...
//  begin
    ...
    begin
      ...
      TNotaNFE_CCEDATA.asDateTime := Now;
    end;
...
begin
  ...
  begin
    ...
    TCadastro.Close;
    if vdest = 'C' then
      TCadastro.Sql.Text:= 'Select * from CADCLIEN where Codigo = ' + TNotaCodigo.AsString
    else
      TCadastro.Sql.Text:= 'Select * from CADFORNE where Codigo = ' + TNotaCodigo.AsString;
    TCadastro.Open;
...
begin
  ...
  if Trim(FormatDateBr(ACBrNFe1.SSL.CertDataVenc)) <> '' then
    tbConfigCER_VALIDADE.asDateTime := StrtoDate(FormatDateBr(ACBrNFe1.SSL.CertDataVenc));
end;
...
var vAux, sXML, idLote, vnotacp: string;
    vDataTime: TDateTime;
begin
  if TNota.isEmpty then exit;
