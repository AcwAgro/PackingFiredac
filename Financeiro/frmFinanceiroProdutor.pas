...
type
  TFfrmFinanceiroProdutor = class(TFModelo)
...
var
  FfrmFinanceiroProdutor: TFfrmFinanceiroProdutor;
...
procedure TFfrmFinanceiroProdutor.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFfrmFinanceiroProdutor.FormShow(Sender: TObject);
begin
  inherited;
  if pcItem.ActivePageIndex = 0 then dbDados.SetFocus;
end;

procedure TFfrmFinanceiroProdutor.DBEdit2Exit(Sender: TObject);
begin
  inherited;
  if (vkey = 13) then
  begin
...
procedure TFfrmFinanceiroProdutor.DBEdit5Exit(Sender: TObject);
begin
  inherited;
...
procedure TFfrmFinanceiroProdutor.DBGrid1ColExit(Sender: TObject);
begin
  inherited;
  cdsRomanPro.Edit;
...
procedure TFfrmFinanceiroProdutor.DBGrid1Enter(Sender: TObject);
begin
  inherited;
  keyPreview := False;
  cdsRomanPro.Edit;
...
procedure TFfrmFinanceiroProdutor.DBGrid1Exit(Sender: TObject);
begin
  inherited;
  vKey := 0;
  keyPreview := True;
...
procedure TFfrmFinanceiroProdutor.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFfrmFinanceiroProdutor.dtpDataChange(Sender: TObject);
begin
  inherited;
  cdsDadosDATAFin.Value := dtpData.Date;
end;

procedure TFfrmFinanceiroProdutor.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  FreeAndNil(FfrmRomanFecha);
end;

procedure TFfrmFinanceiroProdutor.sbIncluirClick(Sender: TObject);
begin
...
procedure TFfrmFinanceiroProdutor.fSomaBin;
begin
...
procedure TFfrmFinanceiroProdutor.fFechamento;
...
procedure TFfrmFinanceiroProdutor.fClassifacao(vTip:Boolean);
