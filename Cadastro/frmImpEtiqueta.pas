...
type
  TFfrmImpEtiqueta = class(TForm)
    ...
    sqlDadosLINHA10: TStringField;
    sqlDadosLINHA11: TStringField;
    sqlDadosLINHA12: TStringField;
    sqlDadosLINHA13: TStringField;
    sqlDadosID_LANC: TIntegerField;
    sqlDadosID_LOTE: TIntegerField;
