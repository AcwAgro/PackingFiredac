...
type
  TFfrmRomanFecha = class(TFModelo)
    ...
    sqlRomanMarDATA: TDateTimeField;
    ...
    cdsRomanMarDATA: TDateTimeField;
...
procedure TFfrmRomanFecha.tsDadosShow(Sender: TObject);
begin
  inherited;
...
begin
  ...
  try
    ...
    try
      ...
      fSql(1,['Delete From RomanMarca Where Lanc=0'+cdsDadosLanc.Text],1);
      ...
      try
        ...
        begin
          ...
          begin
            ...
            cdsRomanMerLanc.asInteger   := cdsDadosLanc.asInteger;
            cdsRomanMerLancit.asInteger := frGenerator('ROMANMER','LANCIT',1);
            cdsRomanMerCodiAux.asInteger:= 0;
            cdsRomanMerProdCod.Value    := 0;
            cdsRomanMerProdDes.Text     := 'SEM PRODUTO';
            cdsRomanMerCalibre.asFloat  := 0;
            cdsRomanMerPesoLiq.asFloat  := 0;
            cdsRomanMerQtde.asFloat     := dm.qrProc1.FieldByName('vqtd').asFloat;
            cdsRomanMerLancManual.asString := 'E';
            cdsRomanMer.Post;
          end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              cdsRomanEmbLanc.asInteger   := cdsDadosLanc.asInteger;
              cdsRomanEmbLancit.asInteger := frGenerator('ROMANMER','LANCIT',1);
              cdsRomanEmbProdCod.Value    := 0;
              cdsRomanEmbProdDes.Text     := 'SEM PRODUTO';
              cdsRomanEmbEmbalCod.Value   := dm.qrSql3.FieldByName('BarraCod').Value;
              cdsRomanEmbEmbalDes.Text    := dm.qrSql3.FieldByName('Descricao').Text;
              cdsRomanEmbQtde.asFloat     := dm.qrProc1.FieldByName('vqtd').asFloat;
              cdsRomanEmbData.Value       := cdsDadosData.Value;
      ...
      //Marca
      fProc(1,['Select Numero1, Codigo, Sum(Qtde) as vqtd ',
               '  From '+vdados,
                ' Where Lote = 0'+Trim(cdsDadosLote.AsString),
      ...
      try
        ...
        begin
          ...
          fSql(3,['Select Codigo, Descricao',
                  '  From CadMarca',
                  ' Where Codigo=0'+dm.qrProc1.FieldByName('Numero1').Text],3);
          if dm.qrSql3.RecordCount>0 then
          begin
            fSql(2,['Select Codigo, Descricao',
                    '  From Cadprodu',
            ...
            begin
              ...
              cdsRomanMarQtde.asFloat     := dm.qrProc1.FieldByName('vqtd').asFloat;
              cdsRomanMarData.Value       := cdsDadosData.Value;
              cdsRomanMar.Post;
            end;
          end;
          dm.qrProc1.Next;
        end;
        cdsRomanMar.ApplyUpdates(0);
      except
      end;
...
{        for vfil:=0 to cdsDados.FieldCount-1 do begin
          ...
          dm.TClassif.FieldByName(vtes).Value:=cdsDados.FieldByName(vtes).Value;                                      mm,kkjjllllllllllllllllllllllllllllllllllllllllllllllllllllj
          'h-uy678
        end;}
